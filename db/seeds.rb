...
Assignee.create([
    ...
    {name: "Maren", address: "695 North Avenue NE", city: "Atlanta", state: "GA", what: "assignee", img_url: "assets/images/maren_pic30.jpg"},
    {name: "Katy", address: " 725 Ponce De Leon Ave NE", city: "Atlanta", state: "GA", what: "assignee", img_url: "assets/images/katy_pic30.jpg"}
   ])
